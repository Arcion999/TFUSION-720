...
typedef enum TFusionStatus {
    TFUSION_STATUS_SUCCESS = 0,
    TFUSION_STATUS_INVALID_ARGUMENT = 1,
    TFUSION_STATUS_INVALID_HANDLE = 2,
    TFUSION_STATUS_STALE_HANDLE = 3,
    TFUSION_STATUS_TYPE_MISMATCH = 4,
    TFUSION_STATUS_CONTEXT_MISMATCH = 5,
    TFUSION_STATUS_BUFFER_TOO_SMALL = 6,
    TFUSION_STATUS_VERSION_MISMATCH = 7,
    TFUSION_STATUS_INTERNAL_ERROR = 8,
    TFUSION_STATUS_KERNEL_ERROR = 9,
    TFUSION_STATUS_UNSUPPORTED = 10
} TFusionStatus;

typedef enum TFusionArchitecture {
    TFUSION_ARCHITECTURE_UNKNOWN = 0,
    TFUSION_ARCHITECTURE_X64 = 1
} TFusionArchitecture;

typedef enum TFusionTextField {
    TFUSION_TEXT_COMPILED_OCCT_VERSION = 1,
    TFUSION_TEXT_RUNTIME_OCCT_VERSION = 2,
    TFUSION_TEXT_CONTEXT_CLIENT_NAME = 3,
    TFUSION_TEXT_LAST_DIAGNOSTIC_JSON = 4
} TFusionTextField;

typedef enum TFusionExceptionProbe {
    TFUSION_EXCEPTION_PROBE_OCCT = 1,
    TFUSION_EXCEPTION_PROBE_STANDARD = 2,
    TFUSION_EXCEPTION_PROBE_UNKNOWN = 3
} TFusionExceptionProbe;
